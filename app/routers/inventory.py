...
from fastapi import APIRouter, Request, FastAPI, Query, Path
...
@router.get("/users/{user_id}/inventory", response_model=List[Item])
def get_item(
...
@router.post("/users/{user_id}/item_json")
